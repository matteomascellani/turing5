...
<body>
    <div style="width: 900px;" class="container max-w-full mx-auto pt-4">
        <form method="POST" action="/posts/{{ $post->id }}">
            ...
            <div class="mb-4">
                <label class="font-bold text-gray-800" for="title">Titolo: </label>
            ...
            <div class="mb-4">
                <label class="font-bold text-gray-800" for="content">Descrizione: </label>
            ...
            <button class="bg-blue-500 tracking-wide text-white px-6 py-2 inline-block mb-6 shadow-lg rounded hover:shadow">Aggiorna</button>
            <a href="/posts" class="bg-gray-500 tracking-wide text-white px-6 py-2 inline-block mb-6 shadow-lg rounded hover:shadow">Cancella</a>
