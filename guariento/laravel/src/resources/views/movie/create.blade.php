    ...
    <div class="container p-4">
        ...
        <div class="row mt-4">
            ...
            <div class="col-12 text-center">
                ...
                <h1><span class="text-uppercase">nuovo</span></h1>
            ...
            <div class="col-12 col-lg-8 mx-lg-auto">
                ...
                <form method="POST" action="/movies">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="input-titolo" name="input-titolo" class="form-control"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="input-descrizione" name="input-descrizione" rows="5" class="form-control"
                            style="resize: none;" placeholder="Scrivi la descrizione..."></textarea>
                    </div>

                    <div class="mb-3">
                        <label for="input-regia" class="form-label">Regia</label>
                        <input type="text" id="input-regia" name="input-regia" class="form-control"
                            placeholder="Scrivi il regista...">
                    </div>
